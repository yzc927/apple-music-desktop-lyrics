...
默认启用“跟随 Apple Music 自动显示 / 隐藏”：程序会加入当前用户的 Windows 登录启动项，
在托盘后台等待 Apple Music；检测到 Apple Music 打开时显示歌词窗口，Apple Music 完全退出后隐藏窗口。
...
官方后备显示。若当前 Apple Music 版本未暴露这些元素，则仍按 LRCLIB 时间轴运行。
